...
def create_simple_installer():
    ...
    with open(installer_script, 'w', encoding='utf-8') as f:
        f.write(f'''@echo off
title DeeMusic Installer v1.0.5
color 0A
echo.
echo     ╔══════════════════════════════════════════╗
...
''')
    ...
    # Create zip package
    zip_path = Path("DeeMusic_Installer_v1.0.5.zip")
...
def show_usage_instructions():
    ...
    print("1. Send users the 'DeeMusic_Installer_v1.0.5.zip' file")
    ...
    print("• DeeMusic_Installer_v1.0.5.zip - Distribution package")
